...
$(function () {
    ...
    jQuery("#grid_search_result").jqGrid({
        ...
        ignoreCase: true,
        rowNum: 100,
        colNames: ['Select', 'Memo Number', 'MemoID', 'Memo Type', 'Memo Type ID', 'Category', 'ARN No', 'ARN Name', 'Scheme', 'SchemeCategory', 'From Date', 'To Date', 'Status', 'Raised By', 'Raised On', 'Time', 'Ageing', 'Last Action By', 'Pending With', 'MemoLevel'],
        colModel: [
