...
$(function () {
    ...
    jQuery("#grid_search_result").jqGrid({
        ...
        rowNum: 100,
        ignoreCase: true,
        colNames: ['Select', '<input type="checkbox" id="checkAll" >Select</input>', 'Memo Number', 'Memo Number', 'PaymentMemoId', 'Memo Type', 'Memo Type ID', 'Category', 'ARN No', 'ARN Name', 'Scheme', 'SchemeCategory', 'From Date', 'To Date', 'Status', 'Status', 'Raised By', 'Raised On', 'Time', 'Ageing', 'Last Action By', 'Pending With'],
        ...
        colModel: [
                ...
                { name: 'MemoId', index: 'MemoId', align: 'right', formatter: TieUp.ReturnSearchHyperLink, sorttype: 'integer', searchoptions: { sopt: ['cn', 'eq', 'ne', 'le', 'lt', 'gt', 'ge'] } },
                { name: 'MemoNumber', index: 'MemoNumber', align: 'left', hidden: true, formatter: TieUp.ReturnMemonumberSearchHyperLink, sorttype: 'integer', searchoptions: { sopt: ['cn', 'eq', 'ne', 'le', 'lt', 'gt', 'ge'] } }, { name: 'PaymentMemoId', index: 'PaymentMemoId', align: 'right', hidden: true },
