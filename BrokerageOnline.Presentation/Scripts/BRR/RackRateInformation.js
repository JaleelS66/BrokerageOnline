...
$(function () {
    ...
    jQuery("#grid_search_result").jqGrid({
        ...
        colModel: [
                ...
                { name: 'MemoNumber', index: 'MemoNumber', align: 'left', hidden: true, formatter: RackRate.ReturnMemonumberSearchHyperLink, }, { name: 'PaymentMemoId', index: 'PaymentMemoId', align: 'right', hidden: true },
