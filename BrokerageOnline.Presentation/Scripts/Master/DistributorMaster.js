...
function DistributorMaster() {
    ...
    this.bindAllSubRegions = function (selector) {
        selector.append("<option  value='' selected>Select SubRegion</option>");
    ...
    this.bindAllDistributor = function (selector) {
        selector.jqGrid({
            ...
            height: 300,
            shrinkToFit: false,
            colNames: ['Edit', 'DistributorId', 'Distributor Name', 'DistributorCategoryId', 'Distributor Category Name', 'SubRegionId', 'Sub Region', 'DistributorParent', 'ARN', 'TaxNo', 'Merg Code', 'Status', 'Created On', 'Delete'],
            colModel: [
                    ...
                    { name: 'CreatedOn', width: 200, index: 'CreatedOn', align: 'center', sortable: false, sorttype: 'date', datefmt: 'd/m/Y', searchoptions: { sopt: ['cn', 'eq', 'ne', 'le', 'lt', 'gt', 'ge'] } },
